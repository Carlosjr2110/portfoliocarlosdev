...
const [transitioning, setTransitioning] = useState(false)
  ...
  const goToPrevSlide = () => {
    ...
    <div className="fixed inset-0 flex justify-center items-center bg-white/60">
      <button onClick={goToPrevSlide} className="absolute left-16 top-[220px] md:left-0 md:relative md:top-0 md:flex md:justify-between md:items-center">
      ...
      />
      <button onClick={goToNextSlide} className="absolute top-[220px] right-16 md:right-0 md:relative md:top-0 md:flex md:justify-between md:items-center">
        <img className="w-8 h-8" src={seta_d.src} alt="" />
      </button>
      <button onClick={closeModal} className="absolute top-[220px] md:relative md:flex md:justify-between md:top-0 md:items-center">
